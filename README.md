...
The quotes are not my property not do I say that they are mine or related to me.   
This project uses this [API](https://github.com/Osaidii/Quotes-API).  
This Website is made using just simple HTML, CSS and JS.
If you find any issues or want to contribute please open an issue in the repository.  
